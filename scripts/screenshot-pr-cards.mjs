...
const DB = process.env.DATABASE_URL || "postgres://agenta:agenta@localhost:5432/agenta_agenta_101?sslmode=disable";
...
async function main() {
  ...
  await page.evaluate((t) => localStorage.setItem("agenta_token", t), token);
