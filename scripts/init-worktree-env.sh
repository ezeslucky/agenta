...
postgres_db="agenta_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://agenta:agenta@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
AGENTA_DEV_VERIFICATION_CODE=888888
AGENTA_SERVER_URL=ws://localhost:${backend_port}/ws
