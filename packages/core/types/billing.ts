// Mirrors the agenta-cloud Billing module response shapes
// (agenta-cloud/docs/api/billing.md). These types are the contract our
// frontend consumes via /api/cloud-billing/* — agenta-api itself does
