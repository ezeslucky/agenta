...
const AGENT_STORAGE_KEY = "agenta:chat:selectedAgentId";
const SESSION_STORAGE_KEY = "agenta:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "agenta:chat:drafts";
...
const CHAT_WIDTH_KEY = "agenta:chat:width";
const CHAT_HEIGHT_KEY = "agenta:chat:height";
const CHAT_EXPANDED_KEY = "agenta:chat:expanded";
/**
 ...
 */
const OPEN_KEY = "agenta:chat:isOpen";
