...
export interface MarkdownProps {
  ...
  /**
   * CDN hostname for file card detection (e.g. "agenta-static.copilothub.ai").
...
// and agenta's internal mention/slash protocols.
...
/**
 * Custom URL transform that allows agenta internal protocols while keeping
