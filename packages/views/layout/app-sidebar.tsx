...
import { useScrollFade } from "@agenta/ui/hooks/use-scroll-fade";
...
import { ActorAvatar } from "@agenta/ui/components/common/actor-avatar";
import { Tooltip, TooltipTrigger, TooltipContent } from "@agenta/ui/components/ui/tooltip";
import { Collapsible, CollapsibleTrigger, CollapsibleContent } from "@agenta/ui/components/ui/collapsible";
import { StatusIcon } from "../issues/components/status-icon";
import { useIssueDraftStore } from "@agenta/core/issues/stores/draft-store";
import { openCreateIssueWithPreference } from "@agenta/core/issues/stores/create-mode-store";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
  ...
  SidebarMenuItem,
  SidebarRail,
} from "@agenta/ui/components/ui/sidebar";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
...
import { useCurrentWorkspace, useWorkspacePaths, paths } from "@agenta/core/paths";
import { workspaceListOptions, myInvitationListOptions, workspaceKeys } from "@agenta/core/workspace/queries";
import { resolvePublicFileUrl } from "@agenta/core/workspace/avatar-url";
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import { inboxKeys, deduplicateInboxItems } from "@agenta/core/inbox/queries";
import { api, ApiError } from "@agenta/core/api";
import { useModalStore } from "@agenta/core/modals";
import { useConfigStore } from "@agenta/core/config";
import { useMyRuntimesNeedUpdate } from "@agenta/core/runtimes/hooks";
import { pinListOptions } from "@agenta/core/pins/queries";
import { useDeletePin, useReorderPins } from "@agenta/core/pins/mutations";
import { issueDetailOptions } from "@agenta/core/issues/queries";
import { projectDetailOptions } from "@agenta/core/projects/queries";
import type { PinnedItem } from "@agenta/core/types";
