...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@agenta/ui/components/ui/collapsible";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
...
import { isTaskMessageTaskId, taskMessagesOptions } from "@agenta/core/chat/queries";
import { Markdown } from "@agenta/views/common/markdown";
import { copyText } from "@agenta/ui/lib/clipboard";
import { AttachmentList } from "../../issues/components/comment-card";
import type { AgentAvailability } from "@agenta/core/agents";
import type { ChatMessage, ChatPendingTask, TaskFailureReason } from "@agenta/core/types";
import type { ChatTimelineItem } from "@agenta/core/chat";
...
function TimelineView({
  ...
  isStreaming?: boolean;
  attachments?: import("@agenta/core/types").Attachment[];
}) {
