...
import { SubmitButton } from "@agenta/ui/components/common/submit-button";
import { useChatStore, newSessionDraftKey } from "@agenta/core/chat";
import { createLogger } from "@agenta/core/logger";
import { enterKey, formatShortcut, modKey } from "@agenta/core/platform";
import type { UploadResult } from "@agenta/core/hooks/use-file-upload";
...
export function ChatInput({
  ...
  const handleSend = async () => {
    ...
    // session, not the message — the agent then can't `agenta attachment
