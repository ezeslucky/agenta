...
} from "@agenta/core/dashboard";
import { useCustomPricingStore } from "@agenta/core/runtimes/custom-pricing-store";
...
const EMPTY_DAILY: import("@agenta/core/types").DashboardUsageDaily[] = [];
const EMPTY_BY_AGENT: import("@agenta/core/types").DashboardUsageByAgent[] = [];
const EMPTY_RUNTIME: import("@agenta/core/types").DashboardAgentRunTime[] = [];
const EMPTY_RUNTIME_DAILY: import("@agenta/core/types").DashboardRunTimeDaily[] = [];
