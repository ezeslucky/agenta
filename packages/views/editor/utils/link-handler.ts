...
import { isGlobalPath } from "@agenta/core/paths";
...
/**
 * Open a link — internal paths dispatch agenta:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("agenta:navigate", { detail: { path } }),
    );
  } else {
