...
import { paths, useCurrentWorkspace } from "@agenta/core/paths";
import { resolvePublicFileUrl } from "@agenta/core/workspace/avatar-url";
import { issueKeys } from "@agenta/core/issues/queries";
import { workspaceKeys } from "@agenta/core/workspace/queries";
import type { Agent, CreateIssueRequest, Issue } from "@agenta/core/types";
import {
  Dialog,
  DialogContent,
  DialogDescription,
 ...
 *     2. Find-or-create a "Agenta Helper" agent on the picked runtime
