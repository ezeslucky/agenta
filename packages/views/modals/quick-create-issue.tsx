...
import { DialogTitle } from "@agenta/ui/components/ui/dialog";
...
import { useCurrentWorkspace } from "@agenta/core/paths";
import { agentListOptions, squadListOptions } from "@agenta/core/workspace/queries";
import { projectListOptions } from "@agenta/core/projects/queries";
import {
  useQuickCreateStore,
  type QuickCreateActorType,
} from "@agenta/core/issues/stores/quick-create-store";
...
} from "@agenta/core/runtimes";
import { useFileUpload } from "@agenta/core/hooks/use-file-upload";
import { formatShortcut, modKey, enterKey } from "@agenta/core/platform";
import { contentReferencesAttachment, type Agent, type Attachment, type Squad } from "@agenta/core/types";
...
export function AgentCreatePanel({
  ...
  // bundled agenta CLI to be ≥ MIN_QUICK_CREATE_CLI_VERSION; older
