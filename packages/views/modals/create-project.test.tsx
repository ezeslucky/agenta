...
const longRepoUrl =
  "https://github.com/ezeslucky/a-very-long-repository-name-that-needs-a-tooltip";
const apiRepoUrl = "https://github.com/ezeslucky/api";
const webRepoUrl = "https://github.com/ezeslucky/web";

vi.mock("@tanstack/react-query", () => ({
  useQuery: () => ({ data: [] }),
}));

vi.mock("@agenta/core/projects/mutations", () => ({
  useCreateProject: () => ({ mutateAsync: vi.fn() }),
}));

vi.mock("@agenta/core/projects", () => ({
...
vi.mock("@agenta/ui/components/ui/popover", () => ({
...
vi.mock("@agenta/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));
