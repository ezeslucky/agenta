...
import type { Issue, IssueStatus, IssuePriority, IssueAssigneeType, Attachment } from "@agenta/core/types";
import { contentReferencesAttachment } from "@agenta/core/types";
import {
  DialogContent,
  DialogTitle,
} from "@agenta/ui/components/ui/dialog";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider } from "@agenta/ui/components/ui/tooltip";
import { Button } from "@agenta/ui/components/ui/button";
import { Switch } from "@agenta/ui/components/ui/switch";
...
import { useCurrentWorkspace, useWorkspacePaths } from "@agenta/core/paths";
import { useWorkspaceId } from "@agenta/core/hooks";
import { useIssueDraftStore } from "@agenta/core/issues/stores/draft-store";
import { useCreateModeStore } from "@agenta/core/issues/stores/create-mode-store";
import { useQuickCreateStore } from "@agenta/core/issues/stores/quick-create-store";
import { issueDetailOptions } from "@agenta/core/issues/queries";
import { useCreateIssue, useUpdateIssue } from "@agenta/core/issues/mutations";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const shouldShowBacklogHint =
        ...
        localStorage.getItem("agenta:backlog-agent-hint-dismissed") !== "true";
        ...
        {backlogHintIssueId ? (
          <BacklogAgentHintContent
            ...
            onDismissPermanently={() => {
              localStorage.setItem("agenta:backlog-agent-hint-dismissed", "true");
            }}
            onMoveToTodo={() => {
...
import { Dialog as DialogRoot } from "@agenta/ui/components/ui/dialog";
