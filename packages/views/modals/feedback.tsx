...
import { useCreateFeedback, useFeedbackDraftStore } from "@agenta/core/feedback";
...
import { captureFeedbackOpened } from "@agenta/core/analytics";
      ...
      <DialogContent className="sm:max-w-2xl !h-[28rem] p-0 gap-0 flex flex-col overflow-hidden">
        <DialogHeader className="px-5 pt-4 pb-2 shrink-0">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            ...
            <a
              href="https://github.com/ezeslucky/agenta/issues"
              target="_blank"
