...
vi.mock("@agenta/core/paths", () => ({ useCurrentWorkspace: () => ({ id: "ws1" }) }));
vi.mock("@agenta/core/hooks/use-file-upload", () => ({
  useFileUpload: () => ({ uploadWithToast: vi.fn() }),
}));
vi.mock("@agenta/core/api", () => ({ api: {} }));
vi.mock("@agenta/core/analytics", () => ({ captureFeedbackOpened: vi.fn() }));
