...
vi.mock("@agenta/core/projects/queries", () => ({
...
vi.mock("@agenta/core/issues/mutations", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@agenta/core/issues/mutations")>();
  return {
    ...actual,
