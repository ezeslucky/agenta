...
import type { GitHubPullRequest } from "@agenta/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@agenta/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@agenta/core/github/queries")>(
    "@agenta/core/github/queries",
  );
  return {
    ...actual,
