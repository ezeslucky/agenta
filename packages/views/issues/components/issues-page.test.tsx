...
// Mock @agenta/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@agenta/core/issues/stores/view-store", () => ({
...
vi.mock("@agenta/core/issues/stores/view-store-context", () => ({
...
vi.mock("@agenta/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@agenta/core/issues/stores/selection-store", () => ({
...
vi.mock("@agenta/core/issues/stores/recent-issues-store", () => ({
