...
import { Calendar } from "@agenta/ui/components/ui/calendar";
import { Switch } from "@agenta/ui/components/ui/switch";
import {
  ALL_STATUSES,
  PRIORITY_ORDER,
} from "@agenta/core/issues/config";
import { StatusIcon, PriorityIcon } from ".";
import { useQuery } from "@tanstack/react-query";
import { useWorkspaceId } from "@agenta/core/hooks";
import { memberListOptions, agentListOptions, squadListOptions } from "@agenta/core/workspace/queries";
import { projectListOptions } from "@agenta/core/projects/queries";
import { labelListOptions } from "@agenta/core/labels/queries";
...
import {
  ...
  type ViewMode,
} from "@agenta/core/issues/stores/view-store";
import { useViewStore, useViewStoreApi } from "@agenta/core/issues/stores/view-store-context";
import { addDaysDateOnly, dateOnlyToLocalDate, formatDateOnly, toDateOnly, todayDateOnly } from "@agenta/core/issues/date";
import {
  useIssuesScopeStore,
  type IssuesScope,
} from "@agenta/core/issues/stores/issues-scope-store";
import { Tooltip, TooltipTrigger, TooltipContent } from "@agenta/ui/components/ui/tooltip";
import type { Issue } from "@agenta/core/types";
