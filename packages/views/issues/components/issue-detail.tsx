...
import { Skeleton } from "@agenta/ui/components/ui/skeleton";
import { Button } from "@agenta/ui/components/ui/button";
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from "@agenta/ui/components/ui/resizable";
import { Sheet, SheetContent } from "@agenta/ui/components/ui/sheet";
import { useIsMobile } from "@agenta/ui/hooks/use-mobile";
import { ContentEditor, type ContentEditorRef, TitleEditor, useFileDropZone, FileDropOverlay } from "../../editor";
import { FileUploadButton } from "@agenta/ui/components/common/file-upload-button";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@agenta/ui/components/ui/tooltip";
import { Popover, PopoverTrigger, PopoverContent } from "@agenta/ui/components/ui/popover";
import { Dialog, DialogContent, DialogHeader, DialogTitle } from "@agenta/ui/components/ui/dialog";
import { Checkbox } from "@agenta/ui/components/ui/checkbox";
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem } from "@agenta/ui/components/ui/command";
import { AvatarGroup, AvatarGroupCount } from "@agenta/ui/components/ui/avatar";
import { ActorAvatar } from "../../common/actor-avatar";
import { PropRow } from "../../common/prop-row";
import type { Attachment, Issue, IssueStatus, IssuePriority, TimelineEntry, UpdateIssueRequest } from "@agenta/core/types";
import { contentReferencesAttachment } from "@agenta/core/types";
import { STATUS_CONFIG, PRIORITY_CONFIG } from "@agenta/core/issues/config";
import { formatDateOnly } from "@agenta/core/issues/date";
import { useUpdateIssue } from "@agenta/core/issues/mutations";
...
import { useGitHubSettings } from "@agenta/core/github";
import { useQuery } from "@tanstack/react-query";
import { useAuthStore } from "@agenta/core/auth";
import { useWorkspacePaths } from "@agenta/core/paths";
import { useActorName } from "@agenta/core/workspace/hooks";
import { useWorkspaceId } from "@agenta/core/hooks";
import { useRecentContextStore } from "@agenta/core/chat";
import { issueListOptions, issueDetailOptions, childIssuesOptions, issueUsageOptions, issueAttachmentsOptions } from "@agenta/core/issues/queries";
import { projectDetailOptions } from "@agenta/core/projects/queries";
import { ProjectIcon } from "../../projects/components/project-icon";
import { issueLabelsOptions } from "@agenta/core/labels";
import { memberListOptions, agentListOptions } from "@agenta/core/workspace/queries";
import { useRecentIssuesStore } from "@agenta/core/issues/stores";
import { useIssueSelectionStore } from "@agenta/core/issues/stores/selection-store";
import { BatchActionToolbar } from "./batch-action-toolbar";
import { useIssueTimeline } from "../hooks/use-issue-timeline";
import { useIssueReactions } from "../hooks/use-issue-reactions";
import { useIssueSubscribers } from "../hooks/use-issue-subscribers";
import { ReactionBar } from "@agenta/ui/components/common/reaction-bar";
import { useFileUpload } from "@agenta/core/hooks/use-file-upload";
import { api } from "@agenta/core/api";
import { useTimeAgo } from "../../i18n";
import { cn } from "@agenta/ui/lib/utils";
...
export function IssueDetail({ issueId, onDelete, onDone, defaultSidebarOpen = true, layoutId = "agenta_issue_detail_layout", highlightCommentId }: IssueDetailProps) {
  const { t } = useT("issues");
  ...
  useEffect(() => {
    ...
    const flagKey = `agenta_cmdF_warned:${id}`;
