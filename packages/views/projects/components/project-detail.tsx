...
import { copyText } from "@agenta/ui/lib/clipboard";
import { toast } from "sonner";
import type { Issue, IssueAssigneeGroup, ProjectStatus, ProjectPriority, UpdateIssueRequest } from "@agenta/core/types";
import { useAuthStore } from "@agenta/core/auth";
import { projectDetailOptions } from "@agenta/core/projects/queries";
import { useUpdateProject, useDeleteProject } from "@agenta/core/projects/mutations";
import { pinListOptions } from "@agenta/core/pins";
import { useCreatePin, useDeletePin } from "@agenta/core/pins";
import {
...
import { PROJECT_STATUS_ORDER, PROJECT_STATUS_CONFIG, PROJECT_PRIORITY_ORDER } from "@agenta/core/projects/config";
import { BOARD_STATUSES } from "@agenta/core/issues/config";
import { createIssueViewStore } from "@agenta/core/issues/stores/view-store";
import { ViewStoreProvider, useViewStore } from "@agenta/core/issues/stores/view-store-context";
...
import {
  ...
  DropdownMenuTrigger,
} from "@agenta/ui/components/ui/dropdown-menu";
import {
  Popover,
  PopoverTrigger,
  PopoverContent,
} from "@agenta/ui/components/ui/popover";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@agenta/ui/components/ui/tooltip";
import { EmojiPicker } from "@agenta/ui/components/common/emoji-picker";
...
import {
  ...
  AlertDialogHeader,
  AlertDialogTitle,
} from "@agenta/ui/components/ui/alert-dialog";
...
export function ProjectDetail({ projectId }: { projectId: string }) {
  ...
  const { defaultLayout, onLayoutChanged } = useDefaultLayout({
    id: "agenta_project_detail_layout",
  });
