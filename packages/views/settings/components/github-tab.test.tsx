...
vi.mock("@agenta/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@agenta/core/github")>("@agenta/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/Agenta will stop receiving webhooks/i)).toBeTruthy();
