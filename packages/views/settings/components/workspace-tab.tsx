...
import { Card, CardContent } from "@agenta/ui/components/ui/card";
import {
  AlertDialog,
  AlertDialogContent,
  AlertDialogHeader,
...
import { useLeaveWorkspace, useDeleteWorkspace } from "@agenta/core/workspace/mutations";
...
import { issueKeys } from "@agenta/core/issues/queries";
...
import {
  ...
  useCurrentWorkspace,
  useHasOnboarded,
} from "@agenta/core/paths";
import { setCurrentWorkspace } from "@agenta/core/platform";
import type { Workspace } from "@agenta/core/types";
