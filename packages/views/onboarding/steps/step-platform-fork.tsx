...
import type { AgentRuntime } from "@agenta/core/types";
...
function CliWaitingStatus({ dialogOpen }: { dialogOpen: boolean }) {
  ...
  // Stage thresholds are rough — `agenta setup` typical flow is
      ...
      >
        {stage === "normal" && (
          <>
            ...
            <span className="font-mono">{"agenta setup"}</span>
