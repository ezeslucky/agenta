...
import { ProjectsPage } from "@agenta/views/projects/components";
import { DashboardPage } from "@agenta/views/dashboard";
import { AutopilotsPage } from "@agenta/views/autopilots/components";
import { MyIssuesPage } from "@agenta/views/my-issues";
import { SkillsPage } from "@agenta/views/skills";
import { DesktopRuntimesPage } from "./components/desktop-runtimes-page";
import { DesktopAgentsPage } from "./components/desktop-agents-page";
import { SquadsPage, SquadDetailPage as SquadDetailPageView } from "@agenta/views/squads/components";
import { InboxPage } from "@agenta/views/inbox";
import { SettingsPage } from "@agenta/views/settings";
