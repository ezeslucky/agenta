...
import { AutopilotDetailPage as AutopilotDetail } from "@agenta/views/autopilots/components";
import { useWorkspaceId } from "@agenta/core/hooks";
import { autopilotDetailOptions } from "@agenta/core/autopilots/queries";
