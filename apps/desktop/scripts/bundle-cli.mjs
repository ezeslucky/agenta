#!/usr/bin/env node
// Builds the `agenta` CLI from server/cmd/agenta and copies the binary
...
//
// ldflags mirror `make build` so `agenta --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "agenta.exe" : "agenta";
}
