...
import { captureDownloadPageViewed } from "@agenta/core/analytics";

const ALL_RELEASES_URL =
  "https://github.com/ezeslucky/agenta/releases";
  ...
  return (
    <>
      {/* Positioning context for the dark-variant LandingHeader —
          mirrors agenta-landing.tsx. The header is `absolute top-0
