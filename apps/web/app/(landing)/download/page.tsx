...
export const metadata: Metadata = {
  title: "Download Agenta",
  description:
    "Download Agenta for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Agenta",
    description:
      "Get the Agenta desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
