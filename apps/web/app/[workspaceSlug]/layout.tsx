...
import { WorkspaceSlugProvider, paths } from "@agenta/core/paths";
import { workspaceBySlugOptions } from "@agenta/core/workspace";
import { setCurrentWorkspace } from "@agenta/core/platform";
import { useAuthStore } from "@agenta/core/auth";
import { NoAccessPage } from "@agenta/views/workspace/no-access-page";
import { WelcomeAfterOnboarding } from "@agenta/views/workspace/welcome-after-onboarding";
import { AgentaIcon } from "@agenta/ui/components/common/agenta-icon";
import { useWorkspaceSeen } from "@agenta/views/workspace/use-workspace-seen";
