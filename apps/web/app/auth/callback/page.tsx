...
import { paths, resolvePostAuthDestination } from "@agenta/core/paths";
import { api } from "@agenta/core/api";
import { validateCliCallback, redirectToCliCallback } from "@agenta/views/auth";
import {
  Card,
  CardHeader,
  CardTitle,
      ...
      <div className="flex min-h-screen items-center justify-center">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Opening Agenta</CardTitle>
            <CardDescription>
              You should see a prompt to open the Agenta desktop app. If
