...
import { createBrowserCookieLocaleAdapter } from "@agenta/core/i18n/browser";
import type { LocaleResources, SupportedLocale } from "@agenta/core/i18n";
...
// cookie mode on their next logout/login cycle (logout clears agenta_token).
// Sunset: once telemetry shows <1% of sessions still carry agenta_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("agenta_token"));
  } catch {
    return false;
  }
}
