...
/**
 * Server-side fetcher for the latest Agenta release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/ezeslucky/agenta/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — Agenta doesn't publish prereleases or drafts
