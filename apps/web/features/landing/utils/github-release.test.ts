...
const SAMPLE_LATEST_ASSET = {
  name: "agenta-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/ezeslucky/agenta/releases/download/v0.2.14/agenta-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "agenta-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/ezeslucky/agenta/releases/download/v0.2.13/agenta-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/ezeslucky/agenta/releases/tag/${overrides.tag}`,
