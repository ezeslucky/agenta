...
// ([MUL-2946](https://agenta/issues/MUL-2946)). Subsequent PRs use
...
const (
	// Platform / scheduler side: failure attributable to agenta
	...
	// message. Treated as platform-side because it is a agenta-imposed
