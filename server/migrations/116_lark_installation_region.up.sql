-- Add a per-installation `region` so one agenta deployment can serve
...
-- deployment-wide value (the AGENTA_LARK_HTTP_BASE_URL /
-- AGENTA_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
