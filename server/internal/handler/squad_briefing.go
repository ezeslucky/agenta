...
2. **Delegate by @mention.** Post a single comment on this issue that
   ...
   - **Be terse.** Every Agenta agent already has full context of the
...
3. **Record your evaluation.** After every trigger — whether you delegated,
   ...
   ` + "`" + `agenta squad activity <issue-id> <outcome> --reason "<short reason>"` + "`" + `
...
- ALWAYS call ` + "`" + `agenta squad activity` + "`" + ` before ending your turn —
