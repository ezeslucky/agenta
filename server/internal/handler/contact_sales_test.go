...
func TestCanonicalBusinessEmail(t *testing.T) {
	cases := []struct {
		...
		{"plain", "ada@agenta.ai", "ada@agenta.ai", true},
		{"uppercase normalized", "Ada@Agenta.AI", "ada@agenta.ai", true},
		{"trim whitespace", "  ada@agenta.ai  ", "ada@agenta.ai", true},
		{"display name stripped", "Ada Lovelace <ada@agenta.ai>", "ada@agenta.ai", true},
		{"angle-bracketed", "<ada@agenta.ai>", "ada@agenta.ai", true},
		{"empty", "", "", false},
		{"only whitespace", "   ", "", false},
		{"missing at", "no-at-sign", "", false},
		{"missing local", "@agenta.ai", "", false},
