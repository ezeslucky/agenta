...
// `agenta issue create` call. Pre-validates that the agent is reachable
...
// manual `agenta agent update <id> --status idle` to unwedge. Matches the
...
// daemon-injected AGENTA_QUICK_CREATE_TASK_ID env var, so this lookup is
