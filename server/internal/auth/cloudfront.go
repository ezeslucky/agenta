...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.agenta.ai"
	cookieDomain string // cookie scope, e.g. ".agenta.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.agenta.ai")
//   - COOKIE_DOMAIN           (e.g. ".agenta.ai")
