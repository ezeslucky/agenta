...
// loadTrustedProxies reads the same AGENTA_TRUSTED_PROXIES env var the rest of
...
func loadTrustedProxies() []netip.Prefix {
	raw := strings.TrimSpace(os.Getenv("AGENTA_TRUSTED_PROXIES"))
	if raw == "" {
		return nil
	}
...
// shared AGENTA_TRUSTED_PROXIES value in here at startup.
