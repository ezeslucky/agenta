...
func TestLarkOutcomeReplierIssueCreatedSendsConfirmation(t *testing.T) {
	...
	if !strings.Contains(got.Text, "https://agenta.test/issues/MUL-42") {
		t.Errorf("text should embed the deep link back to Agenta; got %q", got.Text)
	}
