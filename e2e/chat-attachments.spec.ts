 ...
 * The UI wiring is covered by `chat-input.test.tsx` in @agenta/views; this
...
const DATABASE_URL =
  process.env.DATABASE_URL ?? "postgres://agenta:agenta@localhost:5432/agenta?sslmode=disable";
