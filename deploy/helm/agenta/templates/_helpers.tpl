...
under the kustomize layout when installed as `helm install agenta ...`.
*/}}
{{- define "agenta.backend.fullname" -}}
{{ .Release.Name }}-backend
{{- end -}}

{{- define "agenta.frontend.fullname" -}}
{{ .Release.Name }}-frontend
{{- end -}}

{{- define "agenta.postgres.fullname" -}}
...
*/}}
{{- define "agenta.databaseUrl" -}}
postgres://$(POSTGRES_USER):$(POSTGRES_PASSWORD)@{{ include "agenta.postgres.fullname" . }}:5432/$(POSTGRES_DB)?sslmode=disable
{{- end -}}
